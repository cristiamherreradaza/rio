	...
	<div class="card card-custom gutter-b">
		...
		<div class="card-body">
		    <div id="barra-busqueda" style="display: none">
                <form target="_blank" action="{{ url('Reporte/PagosgeneraPdf') }}" method="POST" id="formularioRecibo">
                    @csrf
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <button type="button" class="btn btn-success btn-block" onclick="buscarRecibo()"><i class="fa fa-search"></i>
                                Buscar</button>
                        </div>
                    </div>
                </form>
